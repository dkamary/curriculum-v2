 ...
 */
final class Version20210209113448 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE proposal ADD country_id SMALLINT UNSIGNED NOT NULL, ADD town VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE proposal DROP country_id, DROP town');
    }
}
